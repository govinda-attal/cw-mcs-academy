...
const PROXY_INSTANTIATION_REPLY_ID: u64 = 3;
...
pub fn instantiate(
    ...
    let total_weight = msg.starting_weight * msg.initial_members.len() as u64;
    ...
    //         let inst_msg = ProxyInstantiateMsg {
    //             denom: msg.denom.clone(),
    //             direct_part: msg.direct_part,
    //             half_time: msg.half_time,
